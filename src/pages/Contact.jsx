...
const Contact = ({ theme }) => {
  ...
  const socialLinks = [
    { icon: <Linkedin className="w-4 h-4 sm:w-5 sm:h-5" />, name: "LinkedIn", url: "https://linkedin.com/company/scholchat", color: "hover:text-blue-600" },
    { icon: <Twitter className="w-4 h-4 sm:w-5 sm:h-5" />, name: "Twitter", url: "https://twitter.com/scholchat", color: "hover:text-sky-500" },
    { icon: <Facebook className="w-4 h-4 sm:w-5 sm:h-5" />, name: "Facebook", url: "https://facebook.com/scholchat", color: "hover:text-blue-700" },
    { icon: <Instagram className="w-4 h-4 sm:w-5 sm:h-5" />, name: "Instagram", url: "https://instagram.com/scholchat", color: "hover:text-pink-600" }
  ];
    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h1 className={`text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6 ${themeClasses.text} break-words hyphens-auto`}>
            {t("pages.contact.title")}
          </h1>
          <p className={`text-base sm:text-xl max-w-3xl mx-auto ${themeClasses.subtext} leading-relaxed`}>
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:col-span-3">
            {contactInfo.map((info, index) => (
              ...
              >
                <div className={`w-12 h-12 sm:w-14 sm:h-14 rounded-xl ${info.bgColor} flex items-center justify-center mb-4 ${info.color} group-hover:scale-110 transition-transform`}>
                  {info.icon}
                </div>
                <h3 className={`text-base sm:text-lg font-bold mb-2 ${themeClasses.text} break-words`}>
                  {info.title}
                </h3>
                <p className={`${themeClasses.subtext} text-sm leading-relaxed break-words`}>
                  {info.value}
                </p>
              </motion.a>
            ))}
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className={`p-4 rounded-3xl ${themeClasses.cardBg} border ${themeClasses.border} shadow-xl overflow-hidden group`}>
            ...
            <div className={`p-4 sm:p-8 rounded-3xl ${themeClasses.cardBg} border ${themeClasses.border} shadow-xl`}>
              <h3 className={`text-base sm:text-lg font-bold mb-4 sm:mb-6 ${themeClasses.text} border-b ${themeClasses.border} pb-3`}>
                ...
                {socialLinks.map((social, index) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <span className="font-bold text-sm sm:text-base">{social.name}</span>
                    </div>
      ...
      {showMapModal && (
        ...
        >
          ...
          >
            ...
            {/* Quick Info Footer */}
            <div className={`absolute bottom-6 left-6 right-6 ${themeClasses.cardBg} rounded-2xl p-4 shadow-xl border ${themeClasses.border} backdrop-blur-sm bg-opacity-95`}>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="flex items-center gap-3">
                  <MapPin className="w-5 h-5 text-red-500" />
                  <div>
                    <p className={`text-xs ${themeClasses.subtext}`}>{t("pages.contact.info.address.title")}</p>
                    <p className={`text-sm font-semibold ${themeClasses.text}`}>{t("pages.contact.info.address.value")}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <Phone className="w-5 h-5 text-green-500" />
                  <div>
                    <p className={`text-xs ${themeClasses.subtext}`}>{t("pages.contact.info.phone.title")}</p>
                    <p className={`text-sm font-semibold ${themeClasses.text}`}>{t("pages.contact.info.phone.value")}</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <Clock className="w-5 h-5 text-purple-500" />
                  <div>
                    <p className={`text-xs ${themeClasses.subtext}`}>{t("pages.contact.info.hours.title")}</p>
                    <p className={`text-sm font-semibold ${themeClasses.text}`}>{t("pages.contact.info.hours.value")}</p>
                  </div>
                </div>
              </div>
            </div>
