...
const SolutionDetails = ({ theme }) => {
  ...
  const solutionConfig = useMemo(() => {
    const dataMap = {
      nurseries: {
        ...
        img: "https://images.unsplash.com/photo-1587654780291-39c9404d746b?w=1200",
        badgeKey: "nursery",
      },
      kindergarten: {
        icon: <FontAwesomeIcon icon={faGraduationCap} />,
        img: "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=1200",
        badgeKey: "kindergarten",
      },
      primary: {
        icon: <FontAwesomeIcon icon={faBookOpen} />,
        img: "https://images.unsplash.com/photo-1497633762265-9d179a990aa6?w=1200",
        badgeKey: "primary",
      },
      middle: {
        icon: <FontAwesomeIcon icon={faBookOpen} />,
      ...
      university: {
        ...
        img: "https://images.unsplash.com/photo-1541339907198-e08756dedf3f?w=1200",
        badgeKey: "university",
      },
    };
    ...
    return {
      ...
      badge: t(
        `pages.solutionDetails.badges.${active.badgeKey}`,
        active.badgeKey,
      ),
      description: t(
        `${baseNavKey}.desc`,
      ...
      features: [
        {
          title: t(
            `pages.solutionDetails.features.${id}.f1.title`,
            t("pages.solutionDetails.features.nurseries.f1.title"),
          ),
          desc: t(
            `pages.solutionDetails.features.${id}.f1.desc`,
            t("pages.solutionDetails.features.nurseries.f1.desc"),
          ),
          icon: active.icon,
        },
        {
          title: t(
            `pages.solutionDetails.features.${id}.f2.title`,
            t("pages.solutionDetails.features.nurseries.f2.title"),
          ),
          desc: t(
            `pages.solutionDetails.features.${id}.f2.desc`,
            t("pages.solutionDetails.features.nurseries.f2.desc"),
          ),
          icon: (
            <FontAwesomeIcon icon={faShield} className="text-emerald-500" />
          ),
        },
        {
          title: t(
            `pages.solutionDetails.features.${id}.f3.title`,
            t("pages.solutionDetails.features.nurseries.f3.title"),
          ),
          desc: t(
            `pages.solutionDetails.features.${id}.f3.desc`,
            t("pages.solutionDetails.features.nurseries.f3.desc"),
          ),
          icon: (
  ...
  return (
    <div
      className={`min-h-screen ${themeClasses.bg} transition-colors duration-500 pb-16`}
    >
      {/* Hero Header */}
      <section
        className={`relative pt-32 sm:pt-40 pb-20 sm:pb-32 overflow-hidden ${themeClasses.heroBg || "bg-slate-950"} text-white`}
      >
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            >
              <motion.div
                variants={{
                  hidden: variants.itemInitial,
                  visible: variants.itemAnimate,
                }}
                className="inline-flex items-center gap-3 px-4 py-2 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 mb-8"
              >
                <span className="w-2 h-2 rounded-full bg-blue-400 animate-pulse"></span>
                <span className="text-[10px] font-black uppercase tracking-widest">
                  {solutionConfig.badge}
                </span>
              </motion.div>
              ...
              <motion.h1
                ...
                className="text-4xl sm:text-6xl lg:text-7xl font-black mb-8 leading-[1.05] tracking-tight"
              >
              ...
              <motion.p
                ...
                className="text-lg sm:text-xl text-white/70 mb-12 leading-relaxed max-w-xl"
              >
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">
                    {t("pages.solutionDetails.rating")}
                  </div>
                </div>
              </motion.div>
            </motion.div>
      ...
      {/* Trust Line */}
      <section
        className={`py-12 border-b ${themeClasses.border} overflow-hidden font-black`}
      >
        <div className="container mx-auto px-4 flex flex-wrap justify-center gap-10 sm:gap-24 opacity-30 grayscale hover:opacity-60 transition-opacity">
          {["Microsoft", "Google Education", "UNESCO", "AWS"].map((brand) => (
            <span
              key={brand}
              className={`text-xl sm:text-2xl tracking-tighter ${themeClasses.text}`}
            >
              {brand}
            </span>
          ))}
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10">
          {solutionConfig.features.map((f, i) => (
            ...
            >
              ...
              <h3
                className={`text-2xl sm:text-3xl font-black mb-5 ${themeClasses.text} tracking-tight`}
              >
                {f.title}
              </h3>
              <p
                className={`text-base sm:text-lg leading-relaxed ${themeClasses.subtext}`}
              >
                {f.desc}
              </p>
              <div
                className={`mt-10 flex items-center gap-3 text-blue-600 font-black text-xs sm:text-sm uppercase tracking-widest cursor-pointer group-hover:gap-5 transition-all`}
              >
            ...
            <div className="flex flex-col items-center gap-8">
              ...
              <div className="flex items-center gap-4">
                <div className="flex -space-x-4">
                  {[12, 14, 18, 22, 25].map((i) => (
                    <img
                      ...
                      className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border-[4px] border-slate-950 shadow-lg"
                      alt=""
                    />
                  ))}
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full border-[4px] border-slate-950 bg-slate-900 flex items-center justify-center text-[10px] font-black text-white">
                    +2k
                  </div>
                </div>
                <div className="text-left border-l-2 border-white/10 pl-4">
                  ...
                  <div className="text-blue-500 font-bold text-[9px] uppercase tracking-widest mt-1">
