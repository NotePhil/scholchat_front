...
export const AboutContent = ({ theme }) => {
  ...
  return (
    <>
      <section className={`py-16 ${themeClasses.bg} overflow-hidden`}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.div variants={itemVariants} className={`space-y-6 ${themeClasses.text}`}>
      ...
      <section className={`py-16 ${themeClasses.bg} relative`}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div 
            ...
            variants={containerVariants}
          >
            <motion.div variants={itemVariants} className={`order-2 md:order-1 space-y-6 ${themeClasses.text}`}>
      ...
      <div className={`py-20 ${themeClasses.bg} border-t border-gray-100 dark:border-gray-800`}>
