      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="flex flex-col items-center space-y-16">
          <div className="w-full text-center max-w-6xl mx-auto">
            ...
            <p className={`text-lg md:text-xl ${themeClasses.text} max-w-4xl mx-auto leading-relaxed mb-8`}>
            ...
            <button className="bg-gradient-to-r from-blue-500 to-purple-500 text-white px-8 py-4 rounded-xl font-bold text-lg hover:shadow-lg transition-shadow">
              Discover
            </button>
