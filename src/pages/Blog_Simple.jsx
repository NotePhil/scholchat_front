...
export const Blog = ({ theme = "default" }) => {
  ...
  return (
    <section
      className={`min-h-screen ${themeClasses.bg} py-20 px-4 sm:px-6 lg:px-8`}
    >
      <div className="container mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p
            className={`text-xl ${themeClasses.text} max-w-3xl mx-auto leading-relaxed px-4`}
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {educationalBlogPosts.map((post) => (
            ...
            >
              ...
              <div className="p-8">
                <h3
                  className={`text-xl font-bold ${themeClasses.text} mb-4 leading-tight`}
                >
                  {t(post.titleKey)}
                </h3>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700">
                  <div className="flex items-center gap-3">
                    ...
                    <span
                      className={`${themeClasses.text} text-base font-medium`}
                    >
                      {t(post.authorKey)}
                    </span>
                  </div>
