    ...
    <section className={`min-h-screen ${themeClasses.bg} py-20`}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className={`text-xl ${themeClasses.text} max-w-4xl mx-auto leading-relaxed`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          <div className={`${themeClasses.cardBg} border ${themeClasses.cardBorder} rounded-3xl p-8`}>
            ...
            <button className="bg-gradient-to-r from-blue-500 to-cyan-500 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-shadow">
          ...
          <div className={`${themeClasses.cardBg} border ${themeClasses.cardBorder} rounded-3xl p-8`}>
            ...
            <button className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-shadow">
        ...
        <div className={`${themeClasses.cardBg} border ${themeClasses.cardBorder} rounded-3xl p-12 mb-20`}>
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-3 bg-green-100 dark:bg-green-900 rounded-full px-6 py-2 mb-6">
        ...
        <div className="text-center">
          <div className={`${themeClasses.cardBg} border ${themeClasses.cardBorder} rounded-3xl p-12 max-w-4xl mx-auto`}>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <button className="bg-gradient-to-r from-cyan-500 to-purple-500 text-white px-8 py-4 rounded-xl font-bold text-lg hover:shadow-lg transition-shadow">
                {t("pages.instructor.cta.startFree")}
              </button>
              <button className="bg-gray-100 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 px-8 py-4 rounded-xl font-bold text-lg text-gray-800 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors">
