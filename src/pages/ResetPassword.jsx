...
const ResetPassword = () => {
  ...
  const validateForm = () => {
    ...
    if (formData.password !== formData.confirmPassword) {
      setMessage({
        text: t(
          "forgot_password.password_mismatch",
        ...
        {isValidating ? (
          ...
          >
            ...
            >
              ...
              <p className="text-slate-400 text-lg max-w-sm mx-auto leading-relaxed italic">
                Nous vérifions l'intégrité de votre jeton de réinitialisation et
                établissons une liaison cryptée de bout en bout...
              </p>
            </motion.div>
          ...
          >
            ...
            <p className="text-slate-400 mb-10 text-lg">
              Your password has been successfully updated. Secure access to your
            ...
            <div className="bg-white/5 backdrop-blur-3xl rounded-[2.5rem] border border-white/10 shadow-3xl overflow-hidden">
              ...
              <div className="bg-gradient-to-br from-blue-600 to-indigo-700 p-10 text-center relative">
                ...
                <p className="text-blue-100/70 font-medium italic">
                  Create a strong multi-layered security key
                </p>
              </div>
              ...
              <div className="p-10">
                {message.text && (
                  <motion.div
                    ...
                    className={`mb-8 p-5 rounded-2xl flex items-center gap-4 border ${message.type === "error" ? "bg-rose-500/10 border-rose-500/20 text-rose-300" : "bg-emerald-500/10 border-emerald-500/20 text-emerald-300"}`}
                  >
                    {message.type === "error" ? (
                      <FontAwesomeIcon
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="relative group">
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        placeholder="••••••••"
                        className={`w-full pl-14 pr-14 py-4.5 border rounded-2xl focus:ring-4 transition-all outline-none text-white font-medium ${formData.confirmPassword && formData.password !== formData.confirmPassword ? "bg-rose-500/10 border-rose-500/30 focus:ring-rose-500/20 focus:border-rose-500/50" : "bg-white/5 border-white/10 focus:ring-blue-500/20 focus:border-blue-500/50 focus:bg-white/10"}`}
                        required
                      />
                      <button
                        type="button"
                  ...
                  <div className="grid grid-cols-2 gap-3 p-5 bg-white/5 rounded-2xl border border-white/5">
                    {[
                      ...
                      <div key={rule.key} className="flex items-center gap-2">
                        <div
                          className={`w-1.5 h-1.5 rounded-full ${passwordRules[rule.key] ? "bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)]" : "bg-slate-600"}`}
                        />
                        <span
                          className={`text-[11px] font-semibold tracking-tight ${passwordRules[rule.key] ? "text-slate-200" : "text-slate-500"}`}
                        >
                          {rule.label}
                        </span>
                      </div>
                  ...
                  >
                    ...
                    <div
                      className={`relative w-full py-5 rounded-2xl font-bold text-lg transition-all duration-300 flex items-center justify-center gap-3 ${loading || !Object.values(passwordRules).every(Boolean) ? "bg-slate-800 text-slate-500 cursor-not-allowed" : "bg-gradient-to-r from-blue-600 to-indigo-700 text-white shadow-xl hover:-translate-y-1 active:scale-95"}`}
                    >
                      {loading ? (
                        <>
                          <FontAwesomeIcon
