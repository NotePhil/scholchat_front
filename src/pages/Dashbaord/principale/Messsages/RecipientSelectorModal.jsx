...
const RecipientSelectorModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div
        className={`rounded-xl shadow-2xl w-full max-w-2xl max-h-[80vh] overflow-hidden ${isDark ? "bg-gray-800" : "bg-white"}`}
      >
        <div
          ...
          <div className="space-y-2">
            {filteredUsers.map((user) => (
              ...
              >
                ...
                />
                <div
                  className={`w-8 h-8 rounded-full flex items-center justify-center ${isDark ? "bg-gray-700" : "bg-gray-200"}`}
                >
