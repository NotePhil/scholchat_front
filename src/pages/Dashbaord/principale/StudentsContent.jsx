        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white/70 backdrop-blur-sm border border-white/50 rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
            ...
            <div className="mt-4 flex items-center">
              ...
              <span className="text-slate-500 text-sm">Élèves enregistrés</span>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-amber-600 mt-1">
                  {students.filter((s) => s.etat === "PENDING").length}
                </p>
              </div>
            ...
            <div className="text-center">
              ...
              <p className="text-slate-600 mb-6 max-w-md mx-auto">
                {searchTerm || filterStatus !== "all"
                  ...
                  : "Commencez par ajouter votre premier élève au système."}
              </p>
              {!searchTerm && filterStatus === "all" && (
                <button
                  onClick={() => {
