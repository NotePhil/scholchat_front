            ...
            <div className="flex items-start justify-between">
              <div className="flex items-start">
                <FontAwesomeIcon
                  ...
                  className="w-4 h-4 sm:w-5 sm:h-5 text-red-500 mt-0.5"
                />
                <div className="ml-3">
                    ...
                    {[...Array(totalPages)].map((_, index) => {
                      ...
                      return (
                        <button
                          ...
                          className={`px-2 sm:px-3 py-1 sm:py-2 rounded-lg text-xs sm:text-sm font-medium transition-colors ${isCurrentPage ? "bg-indigo-600 text-white" : "border border-slate-300 hover:bg-slate-50"}`}
                        >
                          {page}
                        </button>
                      );
