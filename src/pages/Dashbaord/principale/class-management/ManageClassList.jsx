...
const ManageClassList = ({
  ...
  const allClasses = useMemo(
    () => [
      ...moderatedClasses.map((c) => ({
        ...c,
        _role: "created",
      })),
      ...assignedModeratorClasses.map((c) => ({
        ...c,
        _role: "moderator",
      })),
      ...publicationClasses.map((c) => ({
        ...c,
        _role: "publication",
      })),
      ...classes.map((c) => ({
  ...
  return (
    <div className="manage-class-list">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
        ...
        <div className="flex items-center gap-2">
          <Button
            icon={<FontAwesomeIcon icon={faArrowsRotate} spin={refreshing} />}
            onClick={onRefresh}
            size="small"
            loading={refreshing}
            style={{
      ...
      {allClasses.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <p className="text-slate-400 text-sm mb-4">
            Créez votre première classe ou rejoignez-en une via le bouton
            ci-dessus.
          </p>
          {onNavigateToCreate && (
            <Button
      ...
      <Modal
        title={
          ...
          >
            ...
            />
            <span>Modifier — {editingClass?.nom}</span>
          </div>
        }
        open={!!editingClass}
        onCancel={() => {
