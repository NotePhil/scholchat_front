        ...
        <div className="p-6 space-y-3">
          ...
          {MODES.map(({ key, icon: Icon, label, desc, color, border, bg }) => (
            <button
              ...
              className={`w-full flex items-center gap-4 p-4 rounded-xl border-2 transition-all text-left ${selected === key ? `${border} ${bg}` : "border-gray-200 dark:border-gray-700 hover:border-gray-300"}`}
            >
              <div
