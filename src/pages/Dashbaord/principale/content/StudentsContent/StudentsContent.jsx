        ...
        safeStudents.map(async (student) => {
          try {
            const studentClasses =
              await accederService.obtenirClassesAccessibles(student.id);
            return {
              ...student,
          ...
          >
            ...
            <div className="relative px-3 sm:px-6 py-3 sm:py-4">
              ...
              <div className="flex items-start gap-3">
                <div
                  className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl flex items-center justify-center text-white font-black text-base sm:text-lg flex-shrink-0"
                  style={{
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3 flex-wrap">
                    {s.email && (
                      <span className="text-blue-100 text-xs">{s.email}</span>
                    )}
                    {s.niveau && (
                      <span className="text-blue-100 text-xs">{s.niveau}</span>
                    )}
                  </div>
                </div>
              </div>
                        ...
                        >
                          <div className="flex items-start justify-between gap-3">
                            <div className="flex-1 min-w-0">
                              ...
                              {cls.moderator &&
                                typeof cls.moderator === "object" && (
                                  <p className="text-xs text-slate-400 mt-0.5">
                                    Modérateur: {cls.moderator.prenom}{" "}
                                    {cls.moderator.nom}
                                  </p>
                                )}
                            </div>
  ...
  return (
    <div className="full-bleed-page">
      <div className="w-full px-3 sm:px-6 py-3 sm:py-6">
            ...
            >
              ...
              <input
                ...
                placeholder={
                  isMobile
                    ? "Rechercher..."
                    : "Rechercher par nom, email, téléphone, niveau..."
                }
                value={searchTerm}
        ...
        {viewMode === "grid" ? (
          <div
            className={`grid ${isMobile ? "grid-cols-1 gap-3" : "grid-cols-1 min-[500px]:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6"}`}
          >
            {filteredStudents.map((student, idx) => (
              ...
              >
                ...
                <div className="p-5 pb-3 relative z-10">
                  <div className="flex items-start justify-between">
                    <div className="flex items-center space-x-4 min-w-0 flex-1">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3
                          className={`font-black tracking-tight ${isDark ? "text-white" : "text-slate-900"} text-sm sm:text-base line-clamp-1 mb-1`}
                        >
                        ...
                        <div className="flex flex-wrap items-center gap-1.5">
                          <Badge
                            status={
                              student.etat === "ACTIVE" ? "success" : "default"
                            }
                ...
                <div className="px-5 pb-5 flex-grow space-y-3 relative z-10">
                  <div
                    className={`p-4 rounded-2xl ${isDark ? "bg-gray-900/40" : "bg-slate-50/50"} space-y-3`}
                  >
                ...
                <div
                  className={`px-5 py-3 ${isDark ? "bg-gray-900/20" : "bg-slate-50/30"} flex items-center justify-between border-t ${isDark ? "border-white/5" : "border-slate-100"}`}
                >
                ...
                <tbody className="bg-white/30 divide-y divide-slate-100">
                  {filteredStudents.map((student) => (
                    ...
                    >
                      ...
                      <td className="px-3 sm:px-6 py-2 sm:py-4 whitespace-nowrap">
                        <span
                          className={`inline-flex items-center px-2 py-1 sm:px-3 sm:py-1 rounded-full text-xs font-medium border ${getStatusBadge(student.etat)}`}
                        >
                          <div
                            className={`w-1 h-1 sm:w-1.5 sm:h-1.5 rounded-full mr-1 sm:mr-2 ${student.etat === "ACTIVE" ? "bg-emerald-500" : student.etat === "PENDING" || student.etat === "AWAITING_VALIDATION" ? "bg-amber-500" : "bg-red-500"}`}
                          ></div>
