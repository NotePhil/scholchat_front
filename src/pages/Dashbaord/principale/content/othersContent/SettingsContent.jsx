...
const Lock = asIconComponent(faLock);
const Palette = asIconComponent(faPalette);
...
const SettingsContent = ({
  ...
  return (
    <div className="transition-all duration-300">
      ...
      <div
        className={`relative overflow-hidden ${isDark ? "bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900" : "bg-gradient-to-br from-white via-blue-50 to-indigo-100"}`}
      >
        <div className="absolute inset-0 bg-grid-pattern opacity-5"></div>
        <div className="relative max-w-7xl mx-auto px-6 py-12">
          <div className="flex items-center gap-4 mb-6">
            <div
              className={`w-16 h-16 rounded-2xl ${isDark ? "bg-gradient-to-br from-blue-600 to-purple-600" : "bg-gradient-to-br from-blue-500 to-indigo-600"} flex items-center justify-center shadow-lg`}
            >
            ...
            <div>
              ...
              <p className={`text-lg ${textSecondaryClass}`}>
                Personnalisez votre expérience ScholChat
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8">
            <div
              className={`${cardBgClass} rounded-xl p-4 border ${borderClass} backdrop-blur-sm`}
            >
              <div className="flex items-center gap-3">
                <div
                  className={`w-10 h-10 rounded-lg ${isDark ? "bg-green-600" : "bg-green-500"} flex items-center justify-center`}
                >
                  <FontAwesomeIcon
                    icon={faUser}
            ...
            >
              <div className="flex items-center gap-3">
                <div
                  className={`w-10 h-10 rounded-lg ${isDark ? "bg-purple-600" : "bg-purple-500"} flex items-center justify-center`}
                >
                  <FontAwesomeIcon
                    icon={faPalette}
                    className="w-5 h-5 text-white"
                ...
                <div>
                  ...
                  <p className={`font-semibold ${textClass}`}>
                    {colorSchemes[currentTheme]?.name}
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="grid grid-cols-1 xl:grid-cols-5 gap-8">
          ...
          <div className="xl:col-span-1">
            <div
              className={`${cardBgClass} rounded-2xl shadow-lg border ${borderClass} p-6 sticky top-6`}
            >
              <div className="mb-6">
                <div
                  className={`w-20 h-20 rounded-2xl ${isDark ? "bg-gradient-to-br from-blue-600 to-purple-600" : "bg-gradient-to-br from-blue-500 to-indigo-600"} flex items-center justify-center mx-auto mb-4 shadow-lg`}
                >
                  <span className="text-2xl font-bold text-white">
                    {userProfile?.prenom?.charAt(0) || "U"}
                    {userProfile?.nom?.charAt(0) || "S"}
                  </span>
                </div>
                ...
                {tabs.map((tab) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-left transition-all duration-300 group ${activeTab === tab.id ? `bg-gradient-to-r ${colorSchemes[currentTheme]?.gradient || "from-blue-500 to-blue-600"} text-white shadow-lg transform scale-105` : `${textClass} hover:${isDark ? "bg-gray-700/50" : "bg-gray-50"} hover:transform hover:scale-105`}`}
                      onClick={() => {
                        setActiveTab(tab.id);
                        setMessage({
                          text: "",
                    ...
                    >
                      <Icon
                        className={`w-5 h-5 transition-transform duration-300 ${activeTab === tab.id ? "" : "group-hover:scale-110"}`}
                      />
          ...
          <div className="xl:col-span-4">
            <div
              className={`${cardBgClass} rounded-2xl shadow-lg border ${borderClass} overflow-hidden`}
            >
              ...
              {activeTab === "profile" && (
                <div className="p-8">
                  ...
                  >
                    <div className="flex flex-col md:flex-row items-center gap-6">
                      <div className="relative">
                        <div
                          className={`w-24 h-24 rounded-2xl ${isDark ? "bg-gradient-to-br from-blue-600 to-purple-600" : "bg-gradient-to-br from-blue-500 to-indigo-600"} flex items-center justify-center shadow-xl`}
                        >
                        ...
                        <button
                          className={`absolute -bottom-2 -right-2 w-8 h-8 ${isDark ? "bg-gray-700" : "bg-white"} rounded-full flex items-center justify-center shadow-lg border-2 ${borderClass} hover:scale-110 transition-transform`}
                        >
                          <FontAwesomeIcon
                            icon={faCamera}
                      ...
                      <div className="text-center md:text-left flex-1">
                        ...
                        <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                          <span
                            className={`px-3 py-1 rounded-full text-sm font-medium ${isDark ? "bg-blue-900/50 text-blue-300" : "bg-blue-100 text-blue-800"}`}
                          >
                            {userProfile?.role || "Utilisateur"}
                          </span>
                          <span
                            className={`px-3 py-1 rounded-full text-sm font-medium ${isDark ? "bg-green-900/50 text-green-300" : "bg-green-100 text-green-800"}`}
                          >
                            Compte Vérifié
                          </span>
                        </div>
                      ...
                      <button
                        ...
                        className={`flex items-center gap-2 px-6 py-3 rounded-xl font-medium transition-all duration-300 transform hover:scale-105 ${editMode ? `bg-gradient-to-r from-red-500 to-red-600 text-white shadow-lg` : `bg-gradient-to-r ${colorSchemes[currentTheme]?.gradient || "from-blue-500 to-blue-600"} text-white shadow-lg`}`}
                      >
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div
                      className={`${isDark ? "bg-gray-800/50" : "bg-gray-50"} rounded-2xl p-6`}
                    >
                      <h3
                        className={`text-xl font-semibold ${textClass} mb-6 flex items-center gap-2`}
                      >
                      ...
                      <div className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            <label
                              className={`block text-sm font-semibold ${textClass} mb-3`}
                            >
                              Prénom
                            </label>
                            <input
                        ...
                        <div>
                          <label
                            className={`block text-sm font-semibold ${textClass} mb-3 flex items-center gap-2`}
                          >
                            <FontAwesomeIcon
                              icon={faEnvelope}
                              className="w-4 h-4"
                  ...
                  {editMode && (
                    <div className="mt-8">
                      ...
                      {message.text && (
                        <div
                          className={`mt-4 p-4 rounded-xl border flex items-center gap-3 ${message.type === "success" ? "bg-green-50 border-green-200 text-green-700" : "bg-red-50 border-red-200 text-red-700"}`}
                        >
                ...
                <div className="p-8">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2">
                      ...
                      >
                        <h3
                          className={`text-xl font-semibold ${textClass} mb-6`}
                        >
                                ...
                                {[
                                  {
                                    ...
                                    ok: passwordData.newPassword.length >= 8,
                                  },
                                  {
                                    label: "Une lettre majuscule (A-Z)",
                                    ok: /[A-Z]/.test(passwordData.newPassword),
                                  },
                                  {
                                  ...
                                  },
                                  {
                                    ...
                                    ok: /[0-9]/.test(passwordData.newPassword),
                                  },
                                  {
                                  ...
                                  >
                                    <div
                                      className={`w-4 h-4 rounded-full flex items-center justify-center flex-shrink-0 ${ok ? "bg-green-500" : "bg-gray-200"}`}
                                    >
                                      {ok && (
                                        <svg
                                    ...
                                    <span
                                      className={`text-xs ${ok ? "text-green-600" : textSecondaryClass}`}
                                    >
                                      {label}
                                    </span>
                                  </div>
                ...
                <div className="p-8">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    >
                      ...
                      {/* Dark Mode Toggle */}
                      <div
                        className={`p-6 rounded-xl border-2 ${isDark ? "border-blue-500 bg-blue-900/20" : "border-gray-200"} mb-6 transition-all duration-300`}
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-4">
                            <div
                              className={`w-12 h-12 rounded-xl ${isDark ? "bg-blue-600" : "bg-yellow-500"} flex items-center justify-center`}
                            >
                              {isDark ? (
                                <FontAwesomeIcon
                                  icon={faMoon}
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          <div
                            className={`p-4 rounded-xl border ${borderClass} text-center hover:${isDark ? "bg-gray-700" : "bg-gray-50"} transition-colors cursor-pointer`}
                          >
                            <FontAwesomeIcon
                              icon={faDesktop}
                              className={`w-6 h-6 mx-auto mb-2 ${textSecondaryClass}`}
                            />
                        ...
                        {Object.entries(colorSchemes).map(
                          ([scheme, config]) => (
                            <div
                              ...
                              className={`cursor-pointer p-4 rounded-xl border-2 transition-all duration-300 transform hover:scale-105 ${currentTheme === scheme ? `border-2 shadow-lg transform scale-105` : `${borderClass} hover:${isDark ? "bg-gray-700/50" : "bg-white"}`}`}
                              style={{
                                borderColor:
                                  currentTheme === scheme
                                    ? config.primary
                            ...
                            >
                              ...
                              <div className="mt-4 h-3 rounded-full overflow-hidden flex">
                                ...
                                <div
                                  className="flex-1"
                                  style={{
                                    backgroundColor: `${config.primary}80`,
                                  }}
                                ></div>
                              </div>
                            </div>
                  ...
                  {/* Additional Settings */}
                  <div
                    className={`${isDark ? "bg-gray-800/50" : "bg-gray-50"} rounded-2xl p-6 mt-8`}
                  >
                    <h3
                      className={`text-xl font-semibold ${textClass} mb-6 flex items-center gap-2`}
                    >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="flex items-center justify-between p-4 rounded-xl border ${borderClass}">
                        ...
                        <button
                          className={`px-4 py-2 rounded-lg border ${borderClass} ${textClass} hover:${isDark ? "bg-gray-700" : "bg-gray-50"} transition-colors`}
                        >
                          Modifier
                        </button>
                      </div>
