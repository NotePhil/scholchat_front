...
const CreditCard = asIconComponent(faCreditCard);
const Smartphone = asIconComponent(faMobileScreen);
...
const PaymentModal = ({
  ...
  const handleSubmit = () => {
    ...
    if (card.number.replace(/\s/g, "").length !== 16)
      errs.number = "16 chiffres requis";
    if (!card.expiry.match(/^(0[1-9]|1[0-2])\/\d{2}$/))
      errs.expiry = "Format MM/AA";
      ...
      >
        ...
        >
          ...
          <div className="px-5 sm:px-6 py-5 sm:py-6">
            {/* Order summary */}
            <div
              className={`rounded-2xl ${summaryBg} border ${border} p-4 mb-5 flex items-center gap-3`}
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                {subLabel && (
                  <p className={`text-xs ${textMuted} truncate`}>{subLabel}</p>
                )}
              </div>
            ...
            <AnimatePresence mode="wait">
              {step === 1 && (
                ...
                >
                  <p className={`text-sm font-medium ${textMain} mb-3`}>
                  ...
                  {PAYMENT_METHODS.map((m) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`w-11 h-11 rounded-xl bg-gradient-to-br ${m.grad} flex items-center justify-center flex-shrink-0 shadow-sm`}
                        >
                        ...
                        <FontAwesomeIcon
                          icon={faChevronLeft}
                          className={`w-4 h-4 rotate-180 ${textMuted}`}
                        />
                      </button>
                    );
                  })}
                  <div
                    className={`flex items-center gap-2 mt-4 pt-4 border-t ${border} text-xs ${textMuted}`}
                  >
                    <FontAwesomeIcon
                      icon={faLock}
                      className="w-3.5 h-3.5 flex-shrink-0"
                    />
                    Paiement simulé à des fins de démonstration — aucune donnée
                  ...
                  {method === "orange" || method === "mtn" ? (
                    <div className="space-y-3">
                      <div className="flex items-center gap-2 mb-1">
                        <div
                          className={`w-8 h-8 rounded-lg bg-gradient-to-br ${selectedMethod.grad} flex items-center justify-center`}
                        >
                          <FontAwesomeIcon
                            icon={faMobileScreen}
                      ...
                      <div className="relative">
                        <FontAwesomeIcon
                          icon={faMobileScreen}
                          className={`absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 ${textMuted}`}
                        />
                        <input
                          type="tel"
                          inputMode="numeric"
                      ...
                      <div
                        className={`p-3 rounded-xl text-xs ${isDark ? "bg-blue-900/20 text-blue-300" : "bg-blue-50 text-blue-700"}`}
                      >
                        💡 Une demande de confirmation sera envoyée sur ce
                        numéro pour valider {montant.toLocaleString("fr-FR")}{" "}
                        FCFA.
                      </div>
                    </div>
                  ) : (
                    <div className="space-y-3">
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setCard((p) => ({
                                ...p,
                                number: formatCard("number", e.target.value),
                              }))
                            }
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setCard((p) => ({
                                ...p,
                                expiry: formatCard("expiry", e.target.value),
                              }))
                            }
                            placeholder="MM/AA"
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setCard((p) => ({
                                ...p,
                                cvv: formatCard("cvv", e.target.value),
                              }))
                            }
                            placeholder="123"
                      ...
                      <div
                        className={`flex items-center gap-2 p-3 rounded-xl text-xs ${isDark ? "bg-blue-900/20 text-blue-300" : "bg-blue-50 text-blue-700"}`}
                      >
                        <FontAwesomeIcon
                          icon={faLock}
                          className="w-3.5 h-3.5 flex-shrink-0"
              ...
              {step === 3 && (
                ...
                >
                  <div className="relative w-16 h-16 mb-5">
                    ...
                    <FontAwesomeIcon
                      icon={faSpinner}
                      className="absolute inset-0 w-16 h-16 text-blue-600 animate-spin"
                    />
                  </div>
                  ...
                  <p className={`text-sm ${textMuted} mt-1`}>
                    {method === "card"
                      ...
                      : "Validation via mobile money en cours"}
                  </p>
                </motion.div>
              )}
              ...
              {step === 4 && (
                ...
                >
                  ...
                  <p className={`font-semibold text-lg ${textMain}`}>
                    Paiement accepté !
                  </p>
                  <p className={`text-sm ${textMuted} mt-1`}>
                    Activation en cours…
